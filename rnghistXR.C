...
void rnghistXR()
{
  ...
  char handle4[40] = "4";
  TF1* fun4 = new TF1("fun4","[0]/((x-4)*(x+4))",4.1, 500);
  //TF1* fun4 = new TF1("fun4","[0]/((x-1)*(x+3))",3.9, 500);
  //TF1* fun4 = new TF1("fun4","[0]/((x-1)*(x+1))",3.9, 500);
  //TF1* fun4 = new TF1("fun4","[0]/((x-1)*(x-1))",3.9, 500);
  //TF1* fun4 = new TF1("fun4","[0]/((x-1)*(x))",3.9, 500);
  //TF1* fun4 = new TF1("fun4","[0]/(pow(x,[1]))",4, 500);
  //TF1* fun4 = new TF1("fun4","[0]/(pow(x-1,[1]))",4, 500);
  //TF1* fun4 = new TF1("fun4","[0]/(pow(x+2,[1]))",4, 500);
  ...
  //TF1* fun6 = new TF1("fun6","[0]/(pow(x-1,[1]))",6, 500);
  //TF1* fun6 = new TF1("fun6","[0]/(pow(x+6,[1]))",6, 500);
  //TF1* fun6 = new TF1("fun6","[0]/((x-1)*(x-2)*(x-3))",6, 500);
  //TF1* fun6 = new TF1("fun6","[0]/((x-1)*(x+1)*(x+3))",6, 500);
  TF1* fun6 = new TF1("fun6","[0]/((x-1)*(x+3)*(x+7))",6, 500);
  ...
  //TF1* fun8 = new TF1("fun8","[0]/(pow(x-1,[1]))",8, 500);
  //TF1* fun8 = new TF1("fun8","[0]/(pow(x+8,[1]))",8, 500);
  //TF1* fun8 = new TF1("fun8","[0]/((x-1)*(x-2)*(x-3)*(x-4))",8, 500);
  //TF1* fun8 = new TF1("fun8","[0]/((x+2)*(x+4)*(x+6)*(x+8))",8, 500);
  //TF1* fun8 = new TF1("fun8","[0]/((x-1)*(x+1)*(x+3)*(x+5))",8, 500);
  TF1* fun8 = new TF1("fun8","[0]/((x-1)*(x+3)*(x+7)*(x+11))",8, 500);
...
void plotfit(TProfile* histogram, TF1* fun, const char* handle)
{
  ...
  histogram->GetYaxis()->SetTitle(Form("c_{2}{%s}",handle));
  ...
  c1->Print(Form("Figures/histogramR_%s_20.png",handle));

  histogram->GetXaxis()->SetRangeUser(0,500);
  histogram->Draw();
  //tex->DrawLatex(xtex,ytex,"500");
  c1->Print(Form("Figures/histogramR_%s_500.png",handle));

  c1->SetLogy(1);
  histogram->Draw();
  //tex->DrawLatex(xtex,ytex,"500logy");
  c1->Print(Form("Figures/histogramR_%s_500logy.png",handle));

  c1->SetLogx(1);
  histogram->Draw();
  //tex->DrawLatex(xtex,ytex,"500logx/y");
  c1->Print(Form("Figures/histogramR_%s_500logylogx.png",handle));
  ...
  c1->Print(Form("Figures/histogramR_%s_fit_500logylogx.png",handle));
  ...
  ytex = 0.73;
  tex->DrawLatex(xtex,ytex,Form("#chi^{2}/NDF = %.2f/%d",chi2,ndf));
  c1->Print(Form("Figures/histogramR_%s_fit_500logy.png",handle));
  ...
  ytex = 0.73;
  tex->DrawLatex(xtex,ytex,Form("#chi^{2}/NDF = %.2f/%d",chi2,ndf));
  c1->Print(Form("Figures/histogramR_%s_fit_500.png",handle));
  ...
  ytex = 0.73;
  tex->DrawLatex(xtex,ytex,Form("#chi^{2}/NDF = %.2f/%d",chi2,ndf));
  c1->Print(Form("Figures/histogramR_%s_fit_20.png",handle));
