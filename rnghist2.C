void rnghist2()
{
  ...
  histogram->Draw();
  c1->Print("histogram_20_4.png");

  histogram->GetXaxis()->SetRangeUser(0,500);
  histogram->Draw();
  c1->Print("histogram_500_4.png");

  c1->SetLogy();
  histogram->Draw();
  c1->Print("histogram_500logy_4.png");

  c1->SetLogx();
  histogram->Draw();
  c1->Print("histogram_500logylogx_4.png");

  // --- correct combinatoric function
  TF1* fun = new TF1("fun","[0]/(x-1)",1.9, 500);

  histogram->Fit(fun,"R");
  c1->Print("histogram_fit_500logylogx_4.png");
