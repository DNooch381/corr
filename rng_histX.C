...
void callXR(int maximum)
{
  ...
  TFile* HistFile2 = new TFile("CondorOutput/Varda2_Trial0001/SumFile_k2.root","read");
  ...
  TFile* HistFile4 = new TFile("CondorOutput/Varda2_Trial0001/SumFile_k4.root","read");
  ...
  TFile* HistFile6 = new TFile("CondorOutput/Varda2_Trial0001/SumFile_k6.root","read");
  ...
  TFile* HistFile8 = new TFile("CondorOutput/Varda2_Trial0001/SumFile_k8.root","read");
